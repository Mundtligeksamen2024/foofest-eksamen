...
// er en funtionel React komponenet, der taget initialSeconds som en prop
...
const CountdownTimer = ({ initialSeconds }) => {
  ...
  // Nedtællingen forsætter selv hvis man opdaterer siden, ved at bruge sessionStorage, til det gemme den aktuelle tid 
  useEffect(() => {
    ...
    // parseInt konveterer værdien fra en streng til et heltal
    ...
    if (storedSeconds > 0) {
      const interval = setInterval(() => {
        ...
        // intervallet kører hvert sekund "1000 millisekunder" og udføre handlingerne fra linje 30
      }, 1000);

      // returnerer en oprydningsfunktion, der sikre at intervallet stoppes korrekt for at forhindre negative tal
  ...
  const handleTimeout = () => {
    ...
    // Ryd sessionStorage - fjerner countdownSeconds fra sessionStorage for at rydde den gemte nedtællingsværdi
