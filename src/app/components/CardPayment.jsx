...
const CardPayment = () => {
  ...
  return (
    <div className="p-6 m-12 border-2 border-Hotpink bg-Black max-w-5xl mx-auto">
        ...
        <section className="w-full max-w-md">
          <form className="flex flex-col space-y-4">
            ...
            <div className="flex justify-center md:justify-start">
              <Link className="mb-4 text-center text-White p-2 font-bold border-2 border-Hotpink hover:bg-Hotpink w-1/2" href={`/booking/orderConfirmation`}>
                COMPLETE PURCHASE
              </Link>
            </div>
          </form>
