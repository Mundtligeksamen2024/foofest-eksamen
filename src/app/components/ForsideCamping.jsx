      ...
      <div className="flex flex-col items-center ">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-9  text-White">
          ...
          <div className="bg-Black transition duration-300 border-2 border-Black">
            <img src="/card5.webp" alt="dummy" className="w-full h-48 object-cover" />
            <div className="p-5">
          ...
          <div className="bg-Black transition duration-300 border-2 border-Black">
            <img src="/card2.webp" alt="dummy" className="w-full h-48 object-cover" />
            <div className="p-5">
          ...
          <div className="bg-Black transition duration-300 border-2 border-Black">
            <img src="/card3.webp" alt="dummy" className="w-full h-48 object-cover" />
            <div className="p-5">
